 ...
 * of the star import are in the same project, not from a plugin/library.
 */
@Retention(RetentionPolicy.SOURCE)
@Target([ElementType.METHOD])
@GroovyASTTransformationClass("ast.virtualdogbert.MockDomainsASTTransformation")
public @interface MockDomains {
