...
class EnforceASTTransformation extends AbstractASTTransformation {
    ...
    void visit(ASTNode[] nodes, SourceUnit sourceUnit) {
        ...
        if (nodes[0] instanceof AnnotationNode && nodes[1] instanceof MethodNode) {
            ...
            //Added to deal with new @Transactional(Grails 3.3/Gorm 6.1) adding some static compilation check.
            methodNode.annotations.removeAll { AnnotationNode node ->
                node.classNode.name == Enforce.class.name
            }
            ...
            //Added to deal with new @Transactional(Grails 3.3/Gorm 6.1) adding some static compilation check.
            classNode.annotations.removeAll { AnnotationNode node ->
                node.classNode.name == Enforce.class.name
            }
        }
    }
